...
:: Android packaging
set AND_CERT_NAME="SparklingNyol"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\SparklingNyol.p12
...
set IOS_PROVISION=cert\SparklingNyol.mobileprovision
...
set APP_ID=air.SparklingNyol

:: Output packages
set DIST_PATH=dist
set DIST_NAME=SparklingNyol
